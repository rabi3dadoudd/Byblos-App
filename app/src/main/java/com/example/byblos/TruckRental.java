...
public class TruckRental extends AppCompatActivity {
    ...
    EditText name;
    EditText rate;
    CheckBox first, last, dob, address, license, kmdriven, pickup, email, returntime, areaused;
    ...
    public void alreadyAvail(String servicename){
        ...
        pickup = findViewById(R.id.checkBox18);
        returntime = findViewById(R.id.checkBox19);
        kmdriven = findViewById(R.id.checkBox20);
        areaused = findViewById(R.id.checkBox10);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.child("hide kmdriven").getValue().toString().equals("true")){
                    kmdriven.setChecked(true);
                }
                if(snapshot.child("hide areaused").getValue().toString().equals("true")){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addService.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (kmdriven.isChecked()){
                    info.child(aName).child("hide kmdriven").setValue("true");
                } else{
                    info.child(aName).child("hide kmdriven").setValue("false");
                }
                if (areaused.isChecked()){
                    info.child(aName).child("hide areaused").setValue("true");
                } else{
                    info.child(aName).child("hide areaused").setValue("false");
                }
                info.child(aName).child("type").setValue("Truck Rental");
